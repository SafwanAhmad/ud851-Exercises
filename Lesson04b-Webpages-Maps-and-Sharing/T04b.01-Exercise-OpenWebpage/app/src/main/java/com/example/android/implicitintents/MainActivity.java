...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String uri = "https://www.udacity.com";
    ...
    private void openWebPage(String uriStr) {
        Uri uri = Uri.parse(uriStr);
        Intent launchPage = new Intent();
        launchPage.setAction(Intent.ACTION_VIEW);
        launchPage.setData(uri);

        PackageManager pm = getPackageManager();

        if(launchPage.resolveActivity(pm) != null) {
